        ...
        body: RefreshIndicator(
          ...
          child: Obx(() {
            if (controller.productListLoaded.isTrue) {
              return controller.productList.value.product!.isNotEmpty
                  ? Padding(
                            ...
                            child: ListTile(
                              ...
                              subtitle: Column(
                                children: [
                                  ...
                                  controller.productList.value.product![index].specialPrice != null
                                      ? Row(
                                          children: [
                                            Text('Special Price: '),
                  ...
                  : NoDataFound(text: "You don't have any products.");
            } else {
              return Center(
